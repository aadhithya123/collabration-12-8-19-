...
public class FriendDaoImpl implements FriendDAO{
	...
	public List<String> showSuggestedFriend(String username) {
		Session session=sessionFactory.getCurrentSession();
		Query query=session.createNativeQuery("select distinct friendname from friend where friendname in (select friendname from friend where username='"+username+"')");
